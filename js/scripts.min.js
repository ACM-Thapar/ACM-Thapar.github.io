if (
  ((function (t, e) {
    ...
    function r(t) {
      var e = {};
      return (
        ht.each(t.match(It) || [], function (t, i) {
          e[i] = !0;
        }),
        e
      );
    ...
    function c(t, e, i, n) {
      if (Ot(t)) {
        ...
        if (
          ...
          return (
            u || (u = a ? (t[s] = et.pop() || ht.guid++) : s),
            l[u] || (l[u] = a ? {} : { toJSON: ht.noop }),
            ("object" != typeof e && "function" != typeof e) ||
              (n
                ? (l[u] = ht.extend(l[u], e))
                : (l[u].data = ht.extend(l[u].data, e))),
            (r = l[u]),
            n || (r.data || (r.data = {}), (r = r.data)),
            void 0 !== i && (r[ht.camelCase(e)] = i),
            "string" == typeof e
              ? null == (o = r[e]) && (o = r[ht.camelCase(e)])
              : (o = r),
            o
          );
      }
      ...
      if (Ot(t)) {
        ...
        if (s[a]) {
          if (e && (n = i ? s[a] : s[a].data)) {
            ht.isArray(e)
              ? (e = e.concat(ht.map(e, ht.camelCase)))
              : e in n
              ? (e = [e])
              : ((e = ht.camelCase(e)), (e = e in n ? [e] : e.split(" "))),
              (o = e.length);
            for (; o--; ) delete n[e[o]];
            if (i ? !u(n) : !ht.isEmptyObject(n)) return;
          }
          (i || (delete s[a].data, u(s[a]))) &&
            (r
              ? ht.cleanData([t], !0)
              : ct.deleteExpando || s != s.window
              ? delete s[a]
              : (s[a] = void 0));
        }
      }
    ...
    function f(t, e) {
      ...
      if (!r)
        for (r = [], i = t.childNodes || t; null != (n = i[o]); o++)
          !e || ht.nodeName(n, e) ? r.push(n) : ht.merge(r, f(n, e));
      return void 0 === e || (e && ht.nodeName(t, e)) ? ht.merge([t], r) : r;
    }
    function m(t, e) {
      for (var i, n = 0; null != (i = t[n]); n++)
        ht._data(i, "globalEval", !e || ht._data(e[n], "globalEval"));
    }
    function g(t) {
    ...
    function v(t, e, i, n, o) {
      for (
        var r, s, a, l, u, c, d, h = t.length, v = p(e), y = [], w = 0;
        h > w;
        w++
      )
        if ((s = t[w]) || 0 === s)
          if ("object" === ht.type(s)) ht.merge(y, s.nodeType ? [s] : s);
            ...
            if (
              (!ct.leadingWhitespace &&
                Wt.test(s) &&
                y.push(e.createTextNode(Wt.exec(s)[0])),
              !ct.tbody)
            )
              for (
                r =
                ...
                ht.nodeName((c = s.childNodes[r]), "tbody") &&
                  !c.childNodes.length &&
                  s.removeChild(c);
      ...
      for (
        l && v.removeChild(l),
          ct.appendChecked || ht.grep(f(y, "input"), g),
          w = 0;
        (s = y[w++]);
        ...
        if (n && ht.inArray(s, n) > -1) o && o.push(s);
          ...
          ((a = ht.contains(s.ownerDocument, s)),
    ...
    function I(t, e, i, n) {
      ...
      var o,
        ...
        p = e[0],
        m = ht.isFunction(p);
      if (m || (d > 1 && "string" == typeof p && !ct.checkClone && ee.test(p)))
      ...
      if (
        ...
        for (s = (a = ht.map(f(u, "script"), T)).length; d > c; c++)
          (r = u),
            c !== h &&
              ((r = ht.clone(r, !0, !0)), s && ht.merge(a, f(r, "script"))),
            i.call(t[c], r, c);
        if (s)
          for (
            l = a[a.length - 1].ownerDocument, ht.map(a, _), c = 0;
            s > c;
            c++
          )
            (r = a[c]),
              Ft.test(r.type || "") &&
                !ht._data(r, "globalEval") &&
                ht.contains(l, r) &&
                (r.src
                  ? ht._evalUrl && ht._evalUrl(r.src)
                  : ht.globalEval(
    ...
    function k(t, e, i) {
      for (var n, o = e ? ht.filter(e, t) : t, r = 0; null != (n = o[r]); r++)
        i || 1 !== n.nodeType || ht.cleanData(f(n)),
          n.parentNode &&
            (i && ht.contains(n.ownerDocument, n) && m(f(n, "script")),
    ...
    function O(t) {
      ...
      return (
        i ||
          (("none" !== (i = A(t, e)) && i) ||
            ((re = (
              re || ht("<iframe frameborder='0' width='0' height='0'/>")
    ...
    function N(t, e) {
      for (var i, n, o, r = [], s = 0, a = t.length; a > s; s++)
        (n = t[s]).style &&
          ((r[s] = ht._data(n, "olddisplay")),
          (i = n.style.display),
          e
            ? (r[s] || "none" !== i || (n.style.display = ""),
              "" === n.style.display &&
                zt(n) &&
                (r[s] = ht._data(n, "olddisplay", O(n.nodeName))))
            : ((o = zt(n)),
              ((i && "none" !== i) || !o) &&
                ht._data(n, "olddisplay", o ? i : ht.css(n, "display"))));
      for (s = 0; a > s; s++)
        (n = t[s]).style &&
    ...
    function P(t, e, i, n, o) {
      for (
        ...
        "margin" === i && (s += ht.css(t, i + Pt[r], !0, o)),
          n
            ? ("content" === i && (s -= ht.css(t, "padding" + Pt[r], !0, o)),
              "margin" !== i &&
                (s -= ht.css(t, "border" + Pt[r] + "Width", !0, o)))
            : ((s += ht.css(t, "padding" + Pt[r], !0, o)),
              "padding" !== i &&
                (s += ht.css(t, "border" + Pt[r] + "Width", !0, o)));
      return s;
    }
    function z(t, e, i) {
      ...
      if (0 >= o || null == o) {
        if (
          ((0 > (o = he(t, e, r)) || null == o) && (o = t.style[e]), le.test(o))
        )
          return o;
        (n = s && (ct.boxSizingReliable() || o === t.style[e])),
          (o = parseFloat(o) || 0);
      }
    ...
    function R(t, e) {
      ...
      for (e = e ? 1 : 0; 4 > o; o += 2 - e)
        (i = Pt[o]), (n["margin" + i] = n["padding" + i] = t);
    ...
    function W(t, e) {
      ...
      for (i in t)
        if (
          ...
          (o = e[n]),
          (r = t[i]),
          ht.isArray(r) && ((o = r[1]), (r = t[i] = r[0])),
          i !== n && ((t[n] = r), delete t[i]),
          (s = ht.cssHooks[n]) && "expand" in s)
        ) {
    ...
    function H(t, e, i) {
      ...
      for (W(c, u.opts.specialEasing); s > r; r++)
        if ((n = H.prefilters[r].call(u, t, c, u.opts)))
          return (
            ht.isFunction(n.stop) &&
              (ht._queueHooks(u.elem, u.opts.queue).stop = ht.proxy(n.stop, n)),
            n
          );
      return (
        ht.map(c, F, u),
        ht.isFunction(u.opts.start) && u.opts.start.call(t, u),
        ht.fx.timer(ht.extend(l, { elem: t, anim: u, queue: u.opts.queue })),
        u
    ...
    (ht.fn = ht.prototype = {
          ...
          if (null != (o = arguments[a]))
            for (n in o)
              (t = s[n]),
                (i = o[n]),
                s !== i &&
                  (u && i && (ht.isPlainObject(i) || (e = ht.isArray(i)))
                    ? (e
                        ? ((e = !1), (r = t && ht.isArray(t) ? t : []))
                        : (r = t && ht.isPlainObject(t) ? t : {}),
                      (s[n] = ht.extend(u, r, i)))
                    : void 0 !== i && (s[n] = i));
        return s;
      }),
      ...
      "function" == typeof Symbol &&
        (ht.fn[Symbol.iterator] = et[Symbol.iterator]),
      ht.each(
    ...
    var vt = (function (t) {
      function e(t, e, i, n) {
        ...
        if (
          !n &&
          ((e ? e.ownerDocument || e : j) !== O && A(e), (e = e || O), L)
        ) {
          if (11 !== m && (d = mt.exec(t)))
            if ((o = d[1])) {
              if (9 === m) {
              ...
              if (
                ...
                return Y.apply(i, e.getElementsByClassName(o)), i;
            }
        ...
        var o = i.length > 0,
          ...
          s = function (n, s, a, l, u) {
            ...
            for (
              ...
              if (r && c) {
                for (
                  d = 0, s || c.ownerDocument === O || (A(c), (a = !L));
                  (h = t[d++]);
      ...
      try {
        Y.apply((Q = G.call(j.childNodes)), j.childNodes),
      ...
      (w = e.support = {}),
        ...
        (A = e.setDocument = function (t) {
          ...
          return n !== O && 9 === n.nodeType && n.documentElement
            ? ((O = n),
              ...
              (w.getElementsByClassName = ft.test(O.getElementsByClassName)),
              (w.getById = o(function (t) {
                return (
                  (D.appendChild(t).id = M),
              ...
              ($ = []),
              (N = []),
              (w.qsa = ft.test(O.querySelectorAll)) &&
                (o(function (t) {
                ...
                ? function (t, e) {
                    ...
                    return (
                      ...
                      (!w.sortDetached && e.compareDocumentPosition(t) === i)
                        ? t === O || (t.ownerDocument === j && z(j, t))
                          ? -1
                          : e === O || (e.ownerDocument === j && z(j, e))
                          ? 1
                          : I
                          ? K(I, t) - K(I, e)
                          : 0
        ...
        (e.attr = function (t, e) {
          ...
          var i = b.attrHandle[e.toLowerCase()],
            n =
              i && Z.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !L) : void 0;
          return void 0 !== n
            ? n
            : w.attributes || !L
            ? t.getAttribute(e)
      ...
      return (
            ...
            for (
              ...
              if (
                ...
                (n = u(
                  ...
                  (gt.test(r[0].type) && l(e.parentNode)) || e
                ))
              ) {
                if ((r.splice(o, 1), !(t = n.length && c(r))))
                  return Y.apply(i, n), i;
                break;
              }
          }
          return (
        ...
        (w.sortStable = M.split("").sort(B).join("") === M),
    ...
    (ht.filter = function (t, e, i) {
      ...
      ht.fn.extend({
        find: function (t) {
          ...
          return (
            (i = this.pushStack(o > 1 ? ht.unique(i) : i)),
        ...
        is: function (t) {
          return !!n(
            this,
            "string" == typeof t && bt.test(t) ? ht(t) : t || [],
            !1
          ).length;
        },
      });
      ...
      if (((i = i || Tt), "string" == typeof t)) {
        ...
        if (n[1]) {
          if (
            ...
            xt.test(n[1]) && ht.isPlainObject(e))
          )
            for (n in e)
              ht.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
          return this;
        }
      ...
      closest: function (t, e) {
        for (
          var i,
            ...
            r = [],
            s =
              bt.test(t) || "string" != typeof t ? ht(t, e || this.context) : 0;
          o > n;
          n++
        )
          for (i = this[n]; i && i !== e; i = i.parentNode)
            if (
              ...
              (s
                ? s.index(i) > -1
                : 1 === i.nodeType && ht.find.matchesSelector(i, t))
            ) {
              r.push(i);
              break;
            }
      ...
      ht.each(
        ...
        function (t, e) {
          ht.fn[t] = function (i, n) {
            ...
            return (
              "Until" !== t.slice(-5) && (n = i),
              n && "string" == typeof n && (o = ht.filter(n, o)),
              this.length > 1 &&
                (St[t] || (o = ht.uniqueSort(o)),
                ...
                (function e(i) {
                  ht.each(i, function (i, n) {
                    ht.isFunction(n)
                      ...
                      : n && n.length && "string" !== ht.type(n) && e(n);
                  });
                })(arguments),
                i && !e && u()),
              this
          ...
          remove: function () {
            return (
              ht.each(arguments, function (t, e) {
                for (var i; (i = ht.inArray(e, s, i)) > -1; )
                  s.splice(i, 1), l >= i && l--;
              }),
              this
            );
    ...
    ht.extend({
      ...
      hasData: function (t) {
        return (
          !!(t = t.nodeType ? ht.cache[t[ht.expando]] : t[ht.expando]) && !u(t)
        );
      },
      data: function (t, e, i) {
        return c(t, e, i);
            ...
            if (
              ...
              for (i = s.length; i--; )
                s[i] &&
                  ...
                  ((n = ht.camelCase(n.slice(5))), l(r, n, o[n]));
            ...
            arguments.length < i
              ...
              : this.each(function () {
                  ...
                  ht._queueHooks(this, t),
                    "fx" === t && "inprogress" !== i[0] && ht.dequeue(this, t);
                })
          );
        },
        dequeue: function (t) {
    ...
    (ht.event = {
        ...
        if (g) {
          for (
            i.handler && ((l = i), (i = l.handler), (o = l.selector)),
              i.guid || (i.guid = ht.guid++),
              (s = g.events) || (s = g.events = {}),
              (c = g.handle) ||
                ((c = g.handle = function (t) {
                  return void 0 === ht || (t && ht.event.triggered === t.type)
                    ? void 0
                    : ht.event.dispatch.apply(c.elem, arguments);
                }),
                (c.elem = t)),
              a = (e = (e || "").match(It) || [""]).length;
            a--;
            ...
            if (
              ...
              for (
                d = ht.event.special[p] || {},
                  h = c[(p = (n ? d.delegateType : d.bindType) || p)] || [],
                  a =
                    a[2] &&
                    new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                  l = r = h.length;
      ...
      trigger: function (e, i, n, o) {
        ...
        if (
          ...
          3 !== n.nodeType &&
            8 !== n.nodeType &&
            !Vt.test(p + ht.event.triggered) &&
            (p.indexOf(".") > -1 &&
              ((f = p.split(".")), (p = f.shift()), f.sort()),
            (s = p.indexOf(":") < 0 && "on" + p),
            (e = e[ht.expando]
              ? e
              : new ht.Event(p, "object" == typeof e && e)),
            (e.isTrigger = o ? 2 : 3),
            (e.namespace = f.join(".")),
            ...
            (e.result = void 0),
            e.target || (e.target = n),
            (i = null == i ? [e] : ht.makeArray(i, [e])),
            (u = ht.event.special[p] || {}),
            o || !u.trigger || !1 !== u.trigger.apply(n, i)))
        ) {
          if (!o && !u.noBubble && !ht.isWindow(n)) {
            for (
              l = u.delegateType || p, Vt.test(l + p) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              h.push(a), (c = a);
          ...
          for (d = 0; (a = h[d++]) && !e.isPropagationStopped(); )
            (e.type = d > 1 ? l : u.bindType || p),
              (r =
                (ht._data(a, "events") || {})[e.type] &&
                ht._data(a, "handle")) && r.apply(a, i),
              (r = s && a[s]) &&
                r.apply &&
                Ot(a) &&
      ...
      dispatch: function (t) {
        ...
        if (
          ...
          for (
            s = ht.event.handlers.call(this, t, l), e = 0;
            ...
            for (
              ...
              (t.rnamespace && !t.rnamespace.test(r.namespace)) ||
                ...
                void 0 !==
                  (n = (
                    (ht.event.special[r.origType] || {}).handle || r.handler
                  ).apply(o.elem, a)) &&
                  !1 === (t.result = n) &&
      ...
      (ht.Event = function (t, e) {
        return this instanceof ht.Event
          ? (t && t.type
      ...
      ct.submit ||
        (ht.event.special.submit = {
            ...
            return (
              ...
              void ht.event.add(
                ...
                function (t) {
                  ...
                  i &&
                    !ht._data(i, "submit") &&
                    (ht.event.add(i, "submit._submit", function (t) {
                      t._submitBubble = !0;
                    }),
                    ht._data(i, "submit", !0));
                }
          ...
          teardown: function () {
            return (
              !ht.nodeName(this, "form") &&
              void ht.event.remove(this, "._submit")
            );
          },
        }),
      ct.change ||
          ...
          setup: function () {
            return Zt.test(this.nodeName)
              ? (("checkbox" !== this.type && "radio" !== this.type) ||
                ...
                !1)
              : void ht.event.add(this, "beforeactivate._change", function (t) {
                  var e = t.target;
                  Zt.test(e.nodeName) &&
                    !ht._data(e, "change") &&
      ...
      ct.focusin ||
        ht.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
          var i = function (t) {
          ...
          ht.event.special[e] = {
            ...
            teardown: function () {
              ...
              o
                ? ht._data(n, e, o)
                : (n.removeEventListener(t, i, !0), ht._removeData(n, e));
            },
          };
        }),
      ht.fn.extend({
    ...
    ht.extend({
      ...
      clone: function (t, e, i) {
        ...
        if (
          (ct.html5Clone || ht.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">")
            ? (r = t.cloneNode(!0))
        ...
        return (
          (n = f(r, "script")).length > 0 && m(n, !l && f(t, "script")),
          (n = a = o = null),
          r
        );
      },
      cleanData: function (t, e) {
        for (
          ...
          if ((e || Ot(i)) && ((o = i[a]), (r = o && l[o]))) {
            if (r.events)
              for (n in r.events)
                c[n] ? ht.event.remove(i, n) : ht.removeEvent(i, n, r.handle);
            l[o] &&
              (delete l[o],
            ...
            function (t) {
              ...
              if (
                ...
                try {
                  for (; n > i; i++)
                    1 === (e = this[i] || {}).nodeType &&
                      (ht.cleanData(f(e, !1)), (e.innerHTML = t));
                  e = 0;
                } catch (t) {}
              }
        ...
        replaceWith: function () {
          ...
          return I(
            ...
            function (e) {
              ...
              ht.inArray(this, t) < 0 &&
                (ht.cleanData(f(this)), i && i.replaceChild(e, this));
            },
            t
          );
        },
      ...
      ht.each(
        ...
        function (t, e) {
          ht.fn[t] = function (t) {
            for (var i, n = 0, o = [], r = ht(t), s = r.length - 1; s >= n; n++)
    ...
    ht.extend({
      ...
      style: function (t, e, i, n) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var o,
            ...
            l = t.style;
          if (
            ((e = ht.cssProps[a] || (ht.cssProps[a] = L(a) || a)),
      ...
      ht.each(["height", "width"], function (t, e) {
        ht.cssHooks[e] = {
          get: function (t, i, n) {
            return i
              ? ge.test(ht.css(t, "display")) && 0 === t.offsetWidth
                ? ue(t, ye, function () {
                    return z(t, e, n);
                  })
                : z(t, e, n)
            ...
            return $(
              ...
              n
                ? P(
                    ...
                    n,
                    ct.boxSizing &&
                      "border-box" === ht.css(t, "boxSizing", !1, o),
                    o
                  )
                : 0
            );
          ...
          return Mt(
            ...
            function (t, e, i) {
              var n,
                ...
                s = 0;
              if (ht.isArray(e)) {
                for (n = de(t), o = e.length; o > s; s++)
                  r[e[s]] = ht.css(t, e[s], !1, n);
                return r;
              }
        ...
        run: function (t) {
          ...
          return (
            this.options.duration
              ? (this.pos = e = ht.easing[this.easing](
                  t,
    ...
    (ht.Animation = ht.extend(H, {
      ...
      prefilters: [
        function (t, e, i) {
          var n,
            ...
            f = ht._data(t, "fxshow");
          i.queue ||
            (null == (a = ht._queueHooks(t, "fx")).unqueued &&
              ((a.unqueued = 0),
              (l = a.empty.fire),
            ...
            1 === t.nodeType &&
              ...
              "inline" ===
                ("none" === (u = ht.css(t, "display"))
                  ? ht._data(t, "olddisplay") || O(t.nodeName)
                  : u) &&
                "none" === ht.css(t, "float") &&
                (ct.inlineBlockNeedsLayout && "inline" !== O(t.nodeName)
                  ? (h.zoom = 1)
          ...
          if (ht.isEmptyObject(d))
            "inline" === ("none" === u ? O(t.nodeName) : u) && (h.display = u);
          else {
            f
      ...
      (ht.speed = function (t, e, i) {
        ...
        return (
          (n.duration = ht.fx.off
            ? 0
            : "number" == typeof n.duration
            ? n.duration
            : n.duration in ht.fx.speeds
            ? ht.fx.speeds[n.duration]
            : ht.fx.speeds._default),
          (null != n.queue && !0 !== n.queue) || (n.queue = "fx"),
          (n.old = n.complete),
          (n.complete = function () {
            ht.isFunction(n.old) && n.old.call(this),
              n.queue && ht.dequeue(this, n.queue);
          }),
          n
        );
      }),
    ...
    ht.fn.extend({
        ...
        return arguments.length
          ? ((n = ht.isFunction(t)),
            this.each(function (i) {
              var o;
              1 === this.nodeType &&
                (null == (o = n ? t.call(this, i, ht(this).val()) : t)
                  ? (o = "")
                  : "number" == typeof o
                  ? (o += "")
                  : ht.isArray(o) &&
          ...
          : o
          ? (e =
              ht.valHooks[o.type] || ht.valHooks[o.nodeName.toLowerCase()]) &&
            "get" in e &&
      ...
      ht.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (t, e) {
              for (
                var i, n, o = t.options, r = ht.makeArray(e), s = o.length;
                s--;

              )
                if (((n = o[s]), ht.inArray(ht.valHooks.option.get(n), r) > -1))
                  try {
                    n.selected = i = !0;
                  } catch (t) {
                    n.scrollHeight;
      ...
      ht.each(["radio", "checkbox"], function () {
        (ht.valHooks[this] = {
          set: function (t, e) {
            return ht.isArray(e)
              ? (t.checked = ht.inArray(ht(t).val(), e) > -1)
              : void 0;
          },
        }),
          ct.checkOn ||
      ...
      ht.extend({
          ...
          if (3 !== r && 8 !== r && 2 !== r)
            return void 0 === t.getAttribute
              ...
              : ((1 === r && ht.isXMLDoc(t)) ||
                  ((e = e.toLowerCase()),
                  (o =
                    ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ae : ke))),
                void 0 !== i
                  ? null === i
        ...
        removeAttr: function (t, e) {
          ...
          if (r && 1 === t.nodeType)
            for (; (i = r[o++]); )
              (n = ht.propFix[i] || i),
                ht.expr.match.bool.test(i)
                  ? (Ne && Le) || !De.test(i)
                    ? (t[n] = !1)
                    : (t[ht.camelCase("default-" + i)] = t[n] = !1)
                  : ht.attr(t, i, ""),
                t.removeAttribute(Le ? i : n);
        },
      }),
      (Ae = {
        set: function (t, e, i) {
          return (
            !1 === e
              ? ht.removeAttr(t, i)
              : (Ne && Le) || !De.test(i)
              ? t.setAttribute((!Le && ht.propFix[i]) || i, i)
              : (t[ht.camelCase("default-" + i)] = t[i] = !0),
            i
          );
        },
      }),
        ...
        propHooks: {
          tabIndex: {
            get: function (t) {
              ...
              return e
                ? parseInt(e, 10)
                : $e.test(t.nodeName) || (Pe.test(t.nodeName) && t.href)
                ? 0
                : -1;
            },
          },
      ...
      toggleClass: function (t, e) {
        ...
        return "boolean" == typeof e && "string" === i
          ...
          : this.each(function () {
              var e, n, o, r;
              if ("string" === i)
                for (n = 0, o = ht(this), r = t.match(It) || []; (e = r[n++]); )
                  o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
              else
                (void 0 !== t && "boolean" !== i) ||
                  ((e = q(this)) && ht._data(this, "__className__", e),
                  ht.attr(
                    this,
                    "class",
                    e || !1 === t ? "" : ht._data(this, "__className__") || ""
                  ));
            });
      },
      hasClass: function (t) {
    ...
    ht.extend({
      ...
      ajax: function (e, i) {
        function n(e, i, n, o) {
          ...
          2 !== b &&
            ...
            r
              ? (h.ifModified &&
                ...
                204 === e || "HEAD" === h.type
                  ...
                  : 304 === e
                  ? (T = "notmodified")
                  : ((T = w.state), (d = w.data), (y = w.error), (r = !y)))
            ...
            C.statusCode(v),
            (v = void 0),
            u && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, h, r ? d : y]),
            g.fireWith(p, [C, T]),
            u &&
        ...
        if (
          ...
          h.data &&
            ...
            (h.data = ht.param(h.data, h.traditional)),
          U(Xe, h, i, C),
          2 === b)
        )
          return C;
        (u = ht.event && h.global) &&
          ...
          h.hasContent ||
            (h.data &&
              ((s = h.url += (Re.test(s) ? "&" : "?") + h.data), delete h.data),
            !1 === h.cache &&
              (h.url = He.test(s)
                ? s.replace(He, "$1_=" + je++)
                : s + (Re.test(s) ? "&" : "?") + "_=" + je++)),
          h.ifModified &&
            (ht.lastModified[s] &&
              C.setRequestHeader("If-Modified-Since", ht.lastModified[s]),
        ...
        if ((c = U(Ve, h, i, C))) {
          if (((C.readyState = 1), u && f.trigger("ajaxSend", [C, h]), 2 === b))
            return C;
          h.async &&
            h.timeout > 0 &&
      ...
      ht.each(["get", "post"], function (t, e) {
        ht[e] = function (t, i, n, o) {
          return (
            ht.isFunction(i) && ((o = o || n), (n = i), (i = void 0)),
            ht.ajax(
              ht.extend(
    ...
    (ht.param = function (t, e) {
      ...
      if (
        (void 0 === e && (e = ht.ajaxSettings && ht.ajaxSettings.traditional),
    ...
    t.attachEvent &&
      ...
      (ct.cors = !!si && "withCredentials" in si),
      (si = ct.ajax = !!si) &&
      ...
      ht.ajaxTransport("script", function (t) {
        if (t.crossDomain) {
          var e,
            i = it.head || ht("head")[0] || it.documentElement;
          return {
            send: function (n, o) {
    ...
    ht.ajaxSetup({
      ...
      ht.ajaxPrefilter("json jsonp", function (e, i, n) {
        ...
        return a || "jsonp" === e.dataTypes[0]
          ? ((o = e.jsonpCallback = ht.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
            a
              ? (e[a] = e[a].replace(li, "$1" + o))
              : !1 !== e.jsonp &&
                (e.url += (Re.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    (ht.fn.load = function (t, e, i) {
      ...
      var n,
        ...
        a = t.indexOf(" ");
      return (
        a > -1 && ((n = ht.trim(t.slice(a, t.length))), (t = t.slice(0, a))),
        ht.isFunction(e)
          ? ((i = e), (e = void 0))
        ...
        s.length > 0 &&
          ht
            ...
            .done(function (t) {
              (r = arguments),
                s.html(n ? ht("<div>").append(ht.parseHTML(t)).find(n) : t);
            })
            .always(
              i &&
                function (t, e) {
      ...
      (ht.offset = {
        setOffset: function (t, e, i) {
          ...
          "static" === u && (t.style.position = "relative"),
            ...
            (l = ht.css(t, "left")),
            ("absolute" === u || "fixed" === u) &&
            ht.inArray("auto", [r, l]) > -1
              ? ((n = c.position()), (s = n.top), (o = n.left))
              : ((s = parseFloat(r) || 0), (o = parseFloat(l) || 0)),
            ht.isFunction(e) && (e = e.call(t, i, ht.extend({}, a))),
        ...
        position: function () {
          if (this[0]) {
            var t,
              ...
              n = this[0];
            return (
              "fixed" === ht.css(n, "position")
                ? (e = n.getBoundingClientRect())
                : ((t = this.offsetParent()),
                  (e = this.offset()),
                  ht.nodeName(t[0], "html") || (i = t.offset()),
                  (i.top += ht.css(t[0], "borderTopWidth", !0)),
                  (i.left += ht.css(t[0], "borderLeftWidth", !0))),
              {
      ...
      ht.each(["top", "left"], function (t, e) {
        ht.cssHooks[e] = D(ct.pixelPosition, function (t, i) {
          return i
            ? ((i = he(t, e)), le.test(i) ? ht(t).position()[e] + "px" : i)
            : void 0;
        });
      }),
    ...
    var ci = t.jQuery,
      di = t.$;
    return (
      (ht.noConflict = function (e) {
        return (
          t.$ === ht && (t.$ = di), e && t.jQuery === ht && (t.jQuery = ci), ht
        );
      }),
      e || (t.jQuery = t.$ = ht),
      ht
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeInBack: function (t, e, i, n, o, r) {
      return (
        void 0 == r && (r = 1.70158), n * (e /= o) * e * ((r + 1) * e - r) + i
      );
    },
          ...
          (this._setPosition =
            ...
            function (t, i, o, r, s) {
              e.options.horizontalScrolling && n.setLeft(t, i, o),
                e.options.verticalScrolling && n.setTop(t, r, s);
            });
      },
            ...
            this.$element.find("[data-stellar-ratio]").each(function () {
              ...
              e.options.showElement(h),
                ...
                e.particles.push({
                  ...
                  parentOffsetTop: f,
                  stellarRatio:
                    h.data("stellar-ratio") !== n ? h.data("stellar-ratio") : 1,
      ...
      _reset: function () {
        ...
        for (o = this.backgrounds.length - 1; o >= 0; o--)
          (n = this.backgrounds[o]).$element
            ...
            d(n.$element, n.startingValueLeft, n.startingValueTop);
      },
      destroy: function () {
        this._reset(),
          this.$scrollElement
                          ...
                          (n =
                            p && h && o.animatingTo === o.last
                              ...
                              ? (o.itemW + o.vars.itemMargin) *
                                ...
                                o.currentSlide
                              : h
                              ? (o.last - o.currentSlide + o.cloneOffset) * r
                              : (o.currentSlide + o.cloneOffset) * r));
                  },
                  !1
                ),
                (i._slider = o),
              ...
              : ((u = function (s) {
                ...
                (m = function (a) {
                  if (
                    ...
                    o.animatingTo === o.currentSlide && !g && null !== s)
                  ) {
                    var u = h ? -s : s,
  ...
  (function (t, e) {
    ...
    function o(o) {
      if (
        ...
        for (
          var c = (u.isBorderBox = "border-box" == s.boxSizing), d = 0;
          d < l;
          d++
        ) {
          var h = a[d],
    ...
    (e.DEFAULTS = {
      ...
      (t.fn.countTo = function (i) {
        return this.each(function () {
          ...
          r && (o && o.stop(), n.data("countTo", (o = new e(this, s)))),
            o[a].call(o);
        });
      });
  }),
            ...
            (e.index = i.index || 0);
        {
          if (!e.isOpen) {
            (e.types = []),
              ...
              e.bgOverlay ||
                ((e.bgOverlay = C("bg").on("click" + f, function () {
                  e.close();
                })),
                (e.wrap = C("wrap")
                  .attr("tabindex", -1)
        ...
        getInline: function (i, n) {
          if ((D(), i.src)) {
            ...
            if (r.length) {
              ...
              s &&
                s.tagName &&
                (k || ((I = o.hiddenClass), (k = C(I)), (I = "mfp-" + I)),
                (A = r.after(k).detach().removeClass(I))),
      ...
      proto: {
        ...
        getImage: function (i, n) {
          ...
          if (l.length) {
            ...
            (u.className = "mfp-img"),
              (i.img = t(u).on("load.mfploader", r).on("error.mfploader", s)),
              (u.src = i.src),
    ...
    t.magnificPopup.registerModule("gallery", {
      ...
      proto: {
        ...
        preloadNearbyImages: function () {
          ...
          for (t = 1; (e.direction ? o : n) >= t; t++)
            e._preloadItem(e.index + t);
          for (t = 1; (e.direction ? n : o) >= t; t++)
            e._preloadItem(e.index - t);
        },
      ...
      o.detectFeatures(),
        o.features.oldIE &&
          (o.bind = function (t, e, i, n) {
            e = e.split(" ");
            for (
              var o, r = (n ? "detach" : "attach") + "Event", s = 0;
              s < e.length;
              s++
            )
              if ((o = e[s]))
      ...
      var a,
        ...
        At = function (t, e, i, n, o) {
          (!xt || (o && o !== r.currItem)) &&
            ...
            (t[k] = y + e + "px, " + i + "px" + w + " scale(" + n + ")");
        },
        Ot = function (t) {
          it &&
            (t &&
              (g > r.currItem.fitRatio
                ? xt || (si(r.currItem, !1, !0), (xt = !0))
                : xt && (si(r.currItem), (xt = !1))),
            At(it, ht.x, ht.y, g));
        },
        Dt = function (t) {
          t.container &&
        ...
        Nt = function (t, e) {
          if (!s.loop && e) {
            var i = c + (gt.x * ft - t) / gt.x,
              n = Math.round(t - fe.x);
            ((i < 0 && n > 0) || (i >= Ve() - 1 && n < 0)) &&
              (t = fe.x + n * s.mainScrollEndFriction);
          }
          (fe.x = t), Lt(t, d);
        },
        $t = function (t, e) {
        ...
        jt = function () {
          Mt &&
            (o.unbind(document, "mousemove", jt),
        ...
        Rt = function () {
          o.bind(document, "keydown", r),
            ...
            s.mouseUsed || o.bind(document, "mousemove", jt),
        ...
        ee = {
          ...
          init: function () {
            if (!a && !l) {
              ...
              P || o.bind(r.scrollWrap, f, r),
                Et("initialZoomInEnd", function () {
                  r.setContent(C[0], c - 1),
                    r.setContent(C[2], c + 1),
          ...
          close: function () {
            a &&
              ...
              St("close"),
              Ft(),
              Ge(r.currItem, null, !0, r.destroy));
          },
          destroy: function () {
            St("destroy"),
              Be && clearTimeout(Be),
            ...
            if (0 !== vt) {
              ...
              if (!(t && i < 2)) {
                (r.currItem = Xe(c)),
                  (xt = !1),
                  St("beforeChange", vt),
                  i >= 3 && ((h += vt + (vt > 0 ? -3 : 3)), (i = 3));
                for (var n = 0; n < i; n++)
                  vt > 0
                    ? ((e = C.shift()),
                      (C[2] = e),
                      h++,
                      Lt((h + 2) * gt.x, e.el.style),
                      r.setContent(e, c - i + n + 1 + 1))
                    : ((e = C.pop()),
                      C.unshift(e),
                      h--,
                      Lt(h * gt.x, e.el.style),
                      r.setContent(e, c + i - n - 1 - 1));
                if (it && 1 === Math.abs(vt)) {
                  var o = Xe(T);
          ...
          updateSize: function (e) {
            ...
            if (
              ((pt.x = r.scrollWrap.clientWidth),
              (pt.y = r.scrollWrap.clientHeight),
              Xt(),
              (gt.x = pt.x + Math.round(pt.x * s.spacing)),
              (gt.y = pt.y),
              Nt(gt.x * ft),
              St("beforeResize"),
              void 0 !== h)
              ...
              for (var n, a, l, u = 0; u < 3; u++)
                (n = C[u]),
                  Lt((u + h) * gt.x, n.el.style),
                  (l = c + u - 1),
                  s.loop && Ve() > 2 && (l = Tt(l)),
                  (a = Xe(l)) && (x || a.needsUpdate || !a.bounds)
                    ? (r.cleanSlide(a),
                      r.setContent(n, l),
                      1 === u && ((r.currItem = a), r.updateCurrZoomItem(!0)),
                      (a.needsUpdate = !1))
                    : -1 === n.index && l >= 0 && r.setContent(n, l),
                  a && a.container && (ii(a, pt), si(a), Dt(a));
              x = !1;
            }
            (v = g = r.currItem.initialZoomLevel),
              (et = r.currItem.bounds) &&
                ((ht.x = et.center.x), (ht.y = et.center.y), Ot(!0)),
              St("resize");
          },
        ...
        Te = function (t, e) {
          return (
            ...
            (e(t) ? t : Te(t.parentNode, e))
          );
        },
        _e = {},
        Ee = function (t, e) {
          return (
            (_e.prevent = !Te(t.target, s.isClickableElement)),
        ...
        Ne = function (t) {
          ...
          return (
            A
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Le[0] = Se(t.touches[0], Oe)),
                t.touches.length > 1 && (Le[1] = Se(t.touches[1], De)))
              : ((Oe.x = t.pageX),
                (Oe.y = t.pageY),
                (Oe.id = ""),
                (Le[0] = Oe)),
        ...
        $e = function (t, e) {
          var i,
            ...
            d = fe.x - le.x;
          return (
            (i = l > et.min[t] || l < et.max[t] ? s.panEndFriction : 1),
            (l = ht[t] + e[t] * i),
            ...
            "x" !== t)
              ? void (
                  nt ||
                  Y ||
                  (g > r.currItem.fitRatio && (ht[t] += e[t] * i))
                )
              : (void 0 !== a && (Nt(a, !0), (Y = a !== le.x)),
                et.min.x !== et.max.x &&
                  (void 0 !== o ? (ht.x = o) : Y || (ht.x += e.x * i)),
                void 0 !== a)
          );
        },
        Pe = function (t) {
          ...
          if (G) {
            ...
            if (0 !== t)
              if (
                ...
                if (
                  ((re.x = ie.x), (re.y = ie.y), !oe.x && !oe.y && ve(G[1], ne))
                )
                  return;
                ...
                i >
                  r.currItem.initialZoomLevel +
                    r.currItem.initialZoomLevel / 15 && (lt = !0);
                var n = 1,
                  o = Ht(),
                  a = qt();
                if (i < o)
                ...
                if (
                  (rt &&
                    ((rt = !1),
                    Math.abs(oe.x) >= 10 && (oe.x -= G[0].x - se.x),
                    Math.abs(oe.y) >= 10 && (oe.y -= G[0].y - se.y)),
                  (re.x = ie.x),
                  (re.y = ie.y),
                  0 === oe.x && 0 === oe.y)
                )
            ...
            if ((Jt(), W || (W = Re()), W.calculateSwipeSpeed("x"), q))
              if (Ae() < s.verticalDragRange) r.close();
                ...
                te("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (t) {
                  (ht.y = (r.currItem.initialPosition.y - d) * t + d),
                    kt((1 - h) * t + h),
                    Ot();
                }),
                  St("onVerticalDrag", 1);
              ...
              if (!nt)
                return "swipe" !== a
                  ? void qe()
                  : void (!Y && g > r.currItem.fitRatio && Fe(W));
            }
        },
        Re = function () {
          var t,
            ...
            i = {
              ...
              calculateSwipeSpeed: function (n) {
                ue.length > 1
                  ? ((t = It() - F + 50), (e = ue[ue.length - 2][n]))
                  : ((t = It() - R), (e = se[n])),
                  (i.lastFlickOffset[n] = re[n] - e),
              ...
              panAnimLoop: function () {
                if (
                  Vt.zoomPan &&
                  ((Vt.zoomPan.raf = D(i.panAnimLoop)),
                  (i.now = It()),
        ...
        We = function (t, e) {
          ...
          n &&
            ((c += n) < 0
              ? ((c = s.loop ? Ve() - 1 : 0), (u = !0))
              : c >= Ve() && ((c = s.loop ? 0 : Ve() - 1), (u = !0)),
            (u && !s.loop) || ((vt += n), (ft -= n), (i = !0)));
          var d,
            h = gt.x * ft,
            p = Math.abs(h - fe.x);
          return (
            i || h > fe.x == e.lastFlickSpeed.x > 0
              ? ((d =
            ...
            te("mainScroll", fe.x, h, d, o.easing.cubic.out, Nt, function () {
              Jt(),
                (nt = !1),
                (de = -1),
                (i || de !== c) && r.updateCurrItem(),
      ...
      Ct("Gestures", {
        publicMethods: {
          initGestures: function () {
            ...
            (A = M.pointerEvent) && M.touch && (M.touch = !1),
              A
                ...
                function () {
                  if ((St("initialZoom" + (n ? "Out" : "In")), n)) {
                    var r = l.w / e.w,
                      ...
                      p = function (e) {
                        1 === e
                          ? ((g = r), (ht.x = l.x), (ht.y = l.y - z))
                          : ((g = (r - u) * e + u),
                            (ht.x = (l.x - s.x) * e + s.x),
                            (ht.y = (l.y - z - s.y) * e + s.y)),
                          Ot(),
                          a ? (t.style.opacity = 1 - e) : kt(c - e * c);
                      };
                    i
                      ? te("initialZoom", 0, 1, d, o.easing.cubic.out, p, h)
                      : (p(1), (Be = setTimeout(h, d + 20)));
                  } else
                    (g = e.initialZoomLevel),
                      Pt(ht, e.initialPosition),
                      Ot(),
                      kt(1),
                      a ? (t.style.opacity = 1) : kt(1),
                      (Be = setTimeout(h, d + 20));
                },
                n ? 25 : 90
              ));
          })();
        ...
        publicMethods: {
          ...
          initController: function () {
            o.extend(s, ti, !0),
              ...
              Et("mainScrollAnimComplete", ai),
              Et("initialZoomInEnd", ai),
              Et("destroy", function () {
                for (var t, e = 0; e < Ue.length; e++)
                  (t = Ue[e]).container && (t.container = null),
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              Ze || e !== c ? Dt(l) : ((it = u.style), Ge(l, n || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(u);
            } else t.el.innerHTML = "";
          },
        ...
        publicMethods: {
          ...
          handleMouseWheel: function (t) {
            if (g <= r.currItem.fitRatio)
              return (
                s.modal &&
                  (!s.closeOnScroll || Yt || U
                    ? t.preventDefault()
                    : k && Math.abs(t.deltaY) > 2 && ((u = !0), r.close())),
                !0
              );
            if ((t.stopPropagation(), (di.x = 0), "deltaX" in t))
              1 === t.deltaMode
                ? ((di.x = 18 * t.deltaX), (di.y = 18 * t.deltaY))
                : ((di.x = t.deltaX), (di.y = t.deltaY));
            else if ("wheelDelta" in t)
              t.wheelDeltaX && (di.x = -0.16 * t.wheelDeltaX),
                t.wheelDeltaY
                  ? (di.y = -0.16 * t.wheelDeltaY)
                  : (di.y = -0.16 * t.wheelDelta);
            else {
      ...
      Ct("History", {
        publicMethods: {
          ...
          onHashChange: function () {
            return Ei() === yi
              ? ((bi = !0), void r.close())
              : void (mi || ((gi = !0), r.goTo(Ii().pid), (gi = !1)));
          },
          updateURL: function () {
      ...
      var i,
        ...
        q = function () {
          d("onVerticalDrag", function (t) {
            T && t < 0.95
              ? x.hideControls()
              : !T && t >= 0.95 && x.showControls();
          });
          var t;
          d("onPinchClose", function (e) {
            T && e < 0.9
              ? (x.hideControls(), (t = !0))
              : t && !T && e > 0.9 && x.showControls();
          }),
        ...
        (x.onGlobalTap = function (i) {
          ...
          if (!v)
            if (i.detail && "mouse" === i.detail.pointerType) {
              ...
              g.tapToClose && (e.hasClass(n, "pswp__img") || $(n)))
            )
              return void t.close();
        }),
      ...
      (o.prototype.to = function (i, n) {
        if (this.settings.loop) {
          ...
          a < this.settings.items && !1 === l
            ? ((r = s + this._items.length), this.reset(r))
            ...
            (this.e._goToLoop = e.setTimeout(
              t.proxy(function () {
                this.speed(this.duration(this.current(), r + o, n)),
                  this.current(r + o),
                  this.update();
              }, this),
              30
    ...
    (e.Defaults = {
      ...
      (e.prototype.update = function () {
        ...
        if (
          ...
          for (this._pages = [], t = o, e = 0, i = 0; r > t; t++)
            (e >= s || 0 === e) &&
              (this._pages.push({ start: t - o, end: t - o + s - 1 }),
              (e = 0),
              ++i),
